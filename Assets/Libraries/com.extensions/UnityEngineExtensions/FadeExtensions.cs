...
public static class FadeExtensions
{
	...
	public static IEnumerator FadeImage(this Image target, float duration, Color color)
	{
		if (target==null)
			yield break;
	...
	/// <param name="opacity">Opacity.</param>
	/// <param name="duration">Duration.</param>
	public static IEnumerator FadeText(this Text target, float duration, Color color)
	{
		if (target==null)
			yield break;
	...
	/// <param name="opacity">Opacity.</param>
	/// <param name="duration">Duration.</param>
	public static IEnumerator FadeText(this TextMeshProUGUI target, float duration, Color color)
	{
		if (target==null)
			yield break;
	...
	/// <param name="opacity">Opacity.</param>
	/// <param name="duration">Duration.</param>
	public static IEnumerator FadeSprite(this SpriteRenderer target, float duration, Color color)
	{
		if (target==null)
			yield break;
	...
	public static IEnumerator FadeCanvasGroup(this CanvasGroup target, float duration, float targetAlpha, bool unscaled = true)
	{
		if (target==null)
			yield break;
