...
[CanEditMultipleObjects, CustomEditor(typeof(EasyTimer))]
public class TimerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showDisplayInfo)
        {
            ...
            EasyTimer.OutputType tt = (EasyTimer.OutputType)textType_Prop.enumValueIndex;

            switch (tt)
            {
                case EasyTimer.OutputType.StandardText:

                    EditorGUILayout.ObjectField(standardText_Prop);
                    break;

                case EasyTimer.OutputType.TMPro:

                    EditorGUILayout.ObjectField(textMeshPro_Prop);
                    break;

                case EasyTimer.OutputType.HorizontalSlider:
                ...
                case EasyTimer.OutputType.Dial:
