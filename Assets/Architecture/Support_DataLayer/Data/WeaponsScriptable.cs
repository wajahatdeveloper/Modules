...
namespace DataLayer
{
    ...
    public class WeaponsScriptable : ScriptableObject
    {
        ...
        public WeaponRecord GetWeaponRecordByName(string weaponName)
        {
            ...
            var weaponData = weaponDataList.FirstOrDefault(x => x.name.EqualsIgnoreCase(weaponName));
            if (weaponData == null)
            {
                return null;
            }
            ...
            var weaponRecord = new WeaponRecord(weaponData.sprite)
            {
                ...
                weaponCarrierPrefab = weaponData.weaponCarrierPrefab,
                weaponEffectPrefab = weaponData.weaponEffectPrefab,
            };
        ...
        public record WeaponRecord
        {
            ...
            public int price;
            public GameObject weaponCarrierPrefab;
