...
using UnityEditor;
	...
	public class AssetPresetPreprocessor : AssetPostprocessor
	{
		...
		private bool PreloadBase()
		{
			...
			{
				_preprocessBase = ScriptableObjectX.LoadAssetsFromResources<AssetsPresetPreprocessBase>().FirstOrDefault();
				if (_preprocessBase == null) _preprocessBase = ScriptableObjectX.LoadAssets<AssetsPresetPreprocessBase>().SingleOrDefault();
