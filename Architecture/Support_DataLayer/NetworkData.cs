...
namespace DataLayer
{
    ...
    /// <summary>
    /// This is the data that is stored on the network (PUN Room or PUN Players) only
    /// </summary>
    public partial class NetworkData : SingletonBehaviour<NetworkData>
    {
        ...
        public void SetPlayerUserId(string value)
        {
            ...
            UserDataHandler.Instance.SendToDatabaseAsync("userId",value);
        }
        public async Task<string> GetPlayerUserIdAsync()
        {
            string playerUserId = (string) await UserDataHandler.Instance.FetchFromDatabase("userId", "");
